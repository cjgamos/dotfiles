...
// v1.52    Fixes
// v1.60    Added camera effects and zoomcorder integration
  ...
  function TranslationFactory() {
    const translations = {
      en: {
        ...
        notRunning: 'Meet Tweak is not running on this page',
        noMeeting: 'Meet Tweak does not run until you join the meeting',
        enabled: 'Enable Meet Tweak',
        currentRelease: 'Current release',
        donate: 'Support this extension! <br /><small>(make a small donation)</small>',
        donateAdvancedSettings: 'Please, show your interest for Meet Tweak by making a small donation <a href="https://paypal.me/SimoneMarullo" target="_blank">here</a>.',
        advancedSettingsLink: 'View Advanced Settings',
        advancedSettingsTitle: 'Google Meet Tweak Advanced Settings',
