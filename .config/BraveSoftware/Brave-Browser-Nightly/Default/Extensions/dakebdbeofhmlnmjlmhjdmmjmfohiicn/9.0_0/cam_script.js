// ==UserScript==
// @name	Google Meet emojis, text overlay, camera effects
// @version	3.0
// @description	Send emojis, overlay text on video and do camera effects in video meetings
// @author	Zoomcorder.com
// @copyright	2020-2021, Zoomcorder.com
// @license	Zoomcorder.com
// @namespace	https://Zoomcorder.com
// @homepageURL	https://Zoomcorder.com
...
`
	...
	const i18n = {
		...
		text_tip:	{ en: 'Right click here to select emoji \n or type text to  appear over your video',	es: 'Escribe el texto aquí',	fr: 'Écrivez du texte ici',	it: 'Scrivi il testo qui',	pt: 'Escreva o texto aqui',	zh: '在这里写字' },
		donate_tip:	{  },
	}
  ...
  minimize.click();
	...
	// Background Blur for Google Meet does this
