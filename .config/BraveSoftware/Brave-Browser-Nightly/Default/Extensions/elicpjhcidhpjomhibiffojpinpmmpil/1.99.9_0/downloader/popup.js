var aTxt=['idvideo','rights','idTL','idaddvideo','idsimilar','idVDL','idYT','idYT3','idYT2','idnovideo','idwhy',"idwait1","idwait2","idcc","iddownload","idmb","more"];
...
{    
	if ( mode != "m3u8")
	{
		var url = "https://videodownloaderultimate.com/?p=professional";
		if ( showYoutubeMsg)
			url += "&msg="+showYoutubeMsg;		
...
function showVideoUrls( )
{
    ...
    if ( !videoUrls)
    {
        ...
        if ( o)
        {
			...
			if ( showYoutubeMsg)
			{
				o.innerHTML = t["idnovideo"]+"<div id='sep4'></div>";				
			}
			else
			{				
				o.innerHTML = t["idnovideo"]+"<a id='idNoVideoLink' style='margin-left:10px' href='#'>"+t["idwhy"]+"</a><div id='sep4'></div>";
...
document.addEventListener('DOMContentLoaded', function ()
{
	...
	var i = query.indexOf("forbidden=");
	if ( i != -1)
	{
		i+=10;
		showYoutubeMsg=query.substr(i);
		i = showYoutubeMsg.indexOf("&");
		if ( i>=0)
			showYoutubeMsg=showYoutubeMsg.substr(0,i);		
	}
	 /*
    {	
